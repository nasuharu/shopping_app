                  ...
                  <table class="col-md-4 table table-bordered alt-table-responsive jfont" border="1">
                    ...
                    <form class="col-xs-2" method="post" action="{$SCRIPT_NAME}" enctype= "multipart/form-data">
                      <tr>
                        ...
                        <td>
                          <button id="buttonother" class="btn jfont jb" type="submit" name="insert"><i class="fa fa-check" aria-hidden="true"></i>追加</button>
                        </td>
                      </tr>
                      {if ($data)}
                      ...
                      <form method=post action="{$SCRIPT_NAME}">
                        <tr>
                          ...
                          <td>
                            <button id="buttonother" class="btn jfont jb" type="submit" name="delete"><i class="fa fa-times" aria-hidden="true"></i>削除</button>
                            <input type=hidden name=code value={$item.code}>
                            <br>
                            <button id="buttonother" class="btn jfont jb" type="submit" name="update_form"><i class="fa fa-refresh" aria-hidden="true"></i>更新</button>
                            <input type=hidden name=code value={$item.code}>
                          </td>
                        </tr>
                      </form>
