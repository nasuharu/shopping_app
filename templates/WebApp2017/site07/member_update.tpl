      ...
      <div class="row">
        ...
        <div class="col-md-9 content-right">
          ...
          <form name="nameform" method="post" action="auth.php">
            <div class="group">
              <input required="" type="password" name="old_pass"><span class="highlight"></span><span class="bar"></span><label>現在のPassword</label>
            </div>
            <div class="group">
              <input required="" type="password" name="new_pass"><span class="highlight"></span><span class="bar"></span><label>新しいPassword</label>
            </div>
            <input type="hidden" name="type" value="change_password">
            <input type="hidden" name="changed_password">
            <input class="jfont" type="submit" value="変更">
          </form>
